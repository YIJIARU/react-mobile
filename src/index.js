...
import CartsSvg from './assets/carts.svg'
...
export default class TabBarExample extends React.Component {
    ...
    renderContent(pageText) {
      return (
        <div style={{ backgroundColor: 'gray', height  : document.documentElement.clientHeight - 50,
          overflow: 'auto', textAlign: 'center' }}>
            <Switch>
                ...
                <Route path="/product/:id" component={TabDetail}/>
      ...
      return (
        <div style={ { position: 'fixed', height: '100%', width: '100%', top: 0 } }>
          ...
          >
            ...
            key      = "Carts"
            badge    = {'new'}
            selected = {this.state.selectedTab === 'CartsTab'}
            onPress  = {() => {
              this.setState({
                selectedTab: 'CartsTab',
              },()=>{
